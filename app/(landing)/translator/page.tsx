  ...
  return  (
    <>
      <header className="bg-gray-900 text-white">
        <div className="container flex h-16 py-4 items-center justify-between">
        ...
        <div id="main-page" className="container mx-auto p-4">
          <div className="container">
            <div className="flex items-center mb-6">
              <h1 className="text-3xl font-bold mx-auto">SmartServe Translator</h1>
            </div>
            <p className="text-sm text-gray-300 mb-6">Translate text into different languages</p>
            ...
            <textarea
              ...
              className="w-full p-4 bg-blue-950 text-white placeholder-gray-400 placeholder-opacity-75 rounded-md border-none focus:outline-none focus:ring-2 focus:ring-blue-500 mb-6"
