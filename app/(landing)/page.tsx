...
//                         <img className="w-auto h-8 gap-1" src="logo.png" alt="" />
//                         <div className=" text-lg text-white py-1 justify-center ml-2">
//                           Smartserve
//                         </div>
//                     </a>
//                 </div>
...
//                     <a href="/sign-in" title="" className="hidden text-base text-white transition-all duration-200 lg:inline-flex hover:text-opacity-80"> Log in </a>

//                     <a href="/sign-up" title="" className="inline-flex items-center justify-center px-3 sm:px-5 py-2.5 text-sm sm:text-base font-semibold transition-all duration-200 text-white bg-white/20 hover:bg-white/40 focus:bg-white/40 rounded-lg" role="button"> Try for free </a>
//                 </div>
...
//     <section className="relative lg:min-h-[750px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
//         <div className="absolute inset-x-0 bottom-0 z-10 hidden lg:flex">
//             <img className="hidden w-full lg:block" src="#" alt="" />
//             <img className="block w-full lg:hidden" src="#" alt="" />
//         </div>

//         <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
//             <div className="max-w-xl mx-auto text-center">
//                 <h1 className="text-4xl font-bold sm:text-6xl">
//                     <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white transition delay-150 duration-300 ease-in-out ... "> Explore the Power of AI</span>
//                 </h1>
//                 <p className="mt-5 text-base text-white sm:text-xl">Harness the limitless potential of AI through our cutting-edge AI SaaS platform, where innovation meets seamless functionality.</p>
...
//                             />
//                         </svg>
//                         <p className="ml-3 text-sm text-white">Over 12,000 subscribers</p>
//                     </div>
...
//                         </svg>
//                         <p className="ml-3 text-sm text-white">Multiple Services</p>
//                     </div>
