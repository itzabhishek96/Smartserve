...
const LargeCompanyDetails = ({
  ...
  return (
    <article className="flex w-full flex-col bg-darkBG-2 md:gap-14">
      <section className="max-h-48">
        ...
        <div className="relative bottom-8 left-2 flex w-16 items-center justify-center rounded-jobit bg-natural-8 md:left-6">
          <Image
            src={logo}
